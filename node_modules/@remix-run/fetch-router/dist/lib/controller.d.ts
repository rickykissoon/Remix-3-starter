 ...
 */
export type Action<method extends RequestMethod | 'ANY', pattern extends string> = RequestHandlerWithMiddleware<method, pattern> | RequestHandler<method, Params<pattern>>;
