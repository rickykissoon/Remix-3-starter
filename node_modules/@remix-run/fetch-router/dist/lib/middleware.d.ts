...
export declare function runMiddleware<method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}>(middleware: Middleware<method, params>[], context: RequestContext<method, params>, handler: RequestHandler<method, params, Response>): Promise<Response>;
