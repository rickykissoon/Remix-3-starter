...
export function createRouter(options) {
    ...
    function addRoute(method, pattern, action) {
        let routeMiddleware;
        let requestHandler;
    ...
    function mapControllerWithMiddleware(routes, controllerMiddleware, actions) {
        for (let key in routes) {
            ...
            if (route instanceof Route) {
                ...
                mapControllerWithMiddleware(route, controllerMiddleware.concat(action.middleware), action.actions);
            }
            else {
                // Nested controller without middleware - pass down current middleware
                mapControllerWithMiddleware(route, controllerMiddleware, action);
            }
        }
    }
